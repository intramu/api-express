...
export default class adminDAO {
    ...
    async createOrganization(org: Organization) {
        ...
        let conn = null;
        let sqlCreateOrg =
            // "INSERT INTO organization (ID, NAME, INFO, IMAGE, MAIN_COLOR, APPROVAL_STATUS, DATE_CREATED) VALUES (?,?,?,?,?,?,?)";

        // let sqlCreateOrg =
            "INSERT INTO organization (ID, NAME, INFO, IMAGE, MAIN_COLOR, APPROVAL_STATUS, DATE_CREATED) VALUES (UUID_TO_BIN('6ccd780c-baba-1026-9564-5b8c656024db'),?,?,?,?,?,?)";
